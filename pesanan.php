            ...
            <div class="container mt-1 produkheader">
                ...
                <div class="row bawah">
                    <div class="col-sm-8 pro">
                        <a href="pesanan_detail.php?id=<?php echo $da['id_pesan'] ?>"><button class="btn btn-outline-dark">Tampilkan Rincian Pesanan</button></a>
                        ...
                        <?php } else if ($da['status'] == 'verifikasi') { ?>
