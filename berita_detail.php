...
<body>
    ...
    <section class="ftco-about img ftco-section">
        <?php
        $id = $_GET['id'];
        $sql = mysqli_query($con, "SELECT * FROM tb_berita WHERE id_berita='$id'");
        $db = mysqli_fetch_assoc($sql)
        ?>
        <div class="container" style="background: #FFFFF5;">
            <div class="row d-flex no-gutters">
                <div class="col-md-6 col-lg-6 d-flex">
                    <div class="img-about img d-flex align-items-stretch">
                        <div class="img img-video d-flex align-self-stretch align-items-center">
                            <img src="admin/images/berita/<?= $db['gambar_berita']; ?>" alt="" width="100%">
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 pl-md-5">
                    <div class="heading-section ftco-animate">
                        <h2 class="mb-4" style="padding-top: 30%"><?= $db['judul_berita']; ?></h2>
                        <p><?= $db['isi']; ?></p>
                    </div>
                </div>
            </div>
