...
<body>
    ...
    <div class="container judul">
        <div class="row" style="text-align: right;">
            <div class="col">
                <a href="pesanan.php"><i class="fad fa-long-arrow-left"></i>&nbsp; KEMBALI</a>
            </div>
        </div>
    </div>
            ...
            <div class="col konfirm">
                ...
                <p>
                    <?php if ($datapesanan['status'] == "belum bayar") { ?>
                        ...
                        <a href="keranjang_nota.php?id=<?php echo $id ?>" class="btn btn-outline-dark">Nota Pembelian</a>
                    <?php } else if ($datapesanan['status'] == "verifikasi") { ?>
                        <a href="keranjang_nota.php?id=<?php echo $id ?>" class="btn btn-outline-dark">Nota Pembelian</a>
    ...
    <script>
        $(document).ready(function() {
            ...
            <?php } else if ($dat['status'] == "verifikasi") { ?>
                $('#s2p').text('Proses Verifikasi');
